...
interface ComponentProps {
    ...
    /**
     * A string that contains a CSS class that will be appended to the component's default class name.
     *
     * The `appendDefaultClassName` prop is applied to the component's root element. It can be used to add additional CSS classes to the component, which can be useful for styling different states or variants of the component.
     *
     ...
     *
     * typescript
     * appendDefaultClassName="button-active"
     * 
     *
     * The `appendDefaultClassName` prop can also be used to apply dynamic styles to the component. For example, the following `appendDefaultClassName` prop would append a `hovered` class to the component when it is hovered over:
     *
     * typescript
     * appendDefaultClassName={hovered ? "hovered" : ""}
     * 
     */
    appendDefaultClassName?: string;
