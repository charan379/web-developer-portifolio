...
export function InstagramSvgLogo() {
  return (
    <>
      {/* instagram svg  */}
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          ...
          stroke="#ff377a" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        <path
          ...
          stroke="#ff377a" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M17.5 6.49997H17.51" stroke="#ff377a" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </>
  )
}

export default InstagramSvgLogo